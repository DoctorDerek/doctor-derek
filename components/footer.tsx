  ...
  return (
    <footer className="mt-auto md:w-full" aria-labelledby="footer-heading">
      <div className="mx-auto lg:ml-auto lg:mr-0 lg:w-full lg:pl-12 lg:pt-32">
        <div className="">
          {/* ======= SIGN UP ========== */}
          <div className="rounded-tl-3xl bg-[#FB70AA] py-6 md:ml-auto md:w-4/5 md:rounded-tl-[3.5rem] md:py-8 md:pl-4 lg:pb-16 lg:pl-16 lg:pt-20">
            <div className="mx-auto w-11/12">
              <h3 className="pb-3 text-xl md:text-lg md:pb-4 lg:text-2xl">
          ...
          <div className="bg-[#FB70AA] md:bg-transparent">
            <div className="rounded-tl-3xl bg-[#FFE366] md:rounded-tl-[3.5rem]">
              <div className="flex justify-around grid-cols-2 grid-rows-3 py-6 md:grid md:gap-y-2.5 md:ml-8 md:py-8 md:w-3/4 lg:pb-16 lg:pl-14 lg:pt-14">
                <a className="text-lg text-[#311B4D] md:flex"
                ...
                <a
                  className="text-lg text-[#311B4D] md:flex"
                ...
                <a href="#" className="text-lg text-[#311B4D] md:flex">
